...
namespace Chess.Model.Pieces
{
    abstract class Piece
    {
        ...
        virtual public List<string> NextAvailablePositions { get; set; }    // fields available for piece to move in ongoing round
        static public string[] PieceNames => new string[] { "pw", "pb", "Rw", "Rb", "kw", "kb", "Bw", "Bb", "Qw", "Qb", "Kw", "Kb"};

        //abstract public void ReturnAvailablePieceMoves();
